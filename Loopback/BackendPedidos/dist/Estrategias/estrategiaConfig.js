...
exports.estrategiaConfig = void 0;
...
var respuesta = false;
let estrategiaConfig = class estrategiaConfig {
    constructor(servicioAutenticacion) {
        this.servicioAutenticacion = servicioAutenticacion;
        this.name = "config"; // Cambio nombre de la estrategia
    }
            ...
            if (datos) {
                if (datos.data.rol) {
                    ...
                    if (respuesta) {
                        ...
                        throw new rest_1.HttpErrors[401]("ud no es un Configurador y por lo tanto no tiene acceso a este recurso");
                    }
                }
                else {
...
estrategiaConfig = tslib_1.__decorate([
...
exports.estrategiaConfig = estrategiaConfig;
//# sourceMappingURL=estrategiaConfig.js.map
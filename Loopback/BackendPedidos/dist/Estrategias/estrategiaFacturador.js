...
exports.estrategiaFacturador = void 0;
...
var respuesta = false;
let estrategiaFacturador = class estrategiaFacturador {
            ...
            if (datos) {
                if (datos.data.rol) {
                    ...
                    if (respuesta) {
                        ...
                        throw new rest_1.HttpErrors[401]("ud no es un Facturador y por lo tanto no tiene acceso a este recurso");
                    }
                }
                else {
...
estrategiaFacturador = tslib_1.__decorate([
...
], estrategiaFacturador);
exports.estrategiaFacturador = estrategiaFacturador;
//# sourceMappingURL=estrategiaFacturador.js.map
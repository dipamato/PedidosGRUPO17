...
export class estrategiaConfig implements AuthenticationStrategy { //MOdifico nombre de la clase
    name: string = "config"; // Cambio nombre de la estrategia
            ...
            if (datos) {
                if (datos.data.rol) {
                    ...
                    if (respuesta) {
                      ...
                      throw new HttpErrors[401]("ud no es un Configurador y por lo tanto no tiene acceso a este recurso")  
                    }

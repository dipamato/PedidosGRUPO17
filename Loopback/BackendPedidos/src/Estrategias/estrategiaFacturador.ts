...
export class estrategiaFacturador implements AuthenticationStrategy {
    name: string = "fact";
            ...
            if (datos) {
                if (datos.data.rol) {
                    ...
                    if (respuesta) {
                      ...
                      throw new HttpErrors[401]("ud no es un Facturador y por lo tanto no tiene acceso a este recurso")  
                    }
